...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\controller\\postcategorycontroller' => 'AppBundle\\Controller\\PostCategoryController',
            'appbundle\\controller\\postcontroller' => 'AppBundle\\Controller\\PostController',
            'appbundle\\form\\postcategorytype' => 'AppBundle\\Form\\PostCategoryType',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Controller\\PostCategoryController' => __DIR__.'/getPostCategoryControllerService.php',
            'AppBundle\\Controller\\PostController' => __DIR__.'/getPostControllerService.php',
            'AppBundle\\Form\\PostCategoryType' => __DIR__.'/getPostCategoryTypeService.php',
            'AppBundle\\Form\\PostType' => __DIR__.'/getPostTypeService.php',
            ...
            'fragment.renderer.esi' => __DIR__.'/getFragment_Renderer_EsiService.php',
            ...
            'vich_uploader.namer_property.post_image' => __DIR__.'/getVichUploader_NamerProperty_PostImageService.php',
            'vich_uploader.namer_uniqid' => __DIR__.'/getVichUploader_NamerUniqidService.php',
            'vich_uploader.namer_uniqid.item_image' => __DIR__.'/getVichUploader_NamerUniqid_ItemImageService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\PostCategoryType' => true,
            ...
            'vich_uploader.namer_property.post_image' => true,
            'vich_uploader.namer_uniqid' => true,
            'vich_uploader.namer_uniqid.item_image' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rpAovRZlUt', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n6BaTvhaVE', 0, '5CM+k+Evjg3xxNYykpLPyA', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        $this->services['router'] = $instance = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:\\projet-symfony/app/config/routing_dev.yml', array('cache_dir' => $this->targetDirs[0], 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevDebugProjectContainerUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevDebugProjectContainerUrlMatcher', 'strict_requirements' => true), ${($_ = isset($this->services['router.request_context']) ? $this->services['router.request_context'] : $this->getRouter_RequestContextService()) && false ?: '_'});
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(${($_ = isset($this->services['twig.extension.text']) ? $this->services['twig.extension.text'] : $this->services['twig.extension.text'] = new \Twig_Extensions_Extension_Text()) && false ?: '_'});
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($c, 'C:\\projet-symfony\\app', 'UTF-8'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('c9AOTipilB', 0, '5CM+k+Evjg3xxNYykpLPyA', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4vzQ69eubN', 0, '5CM+k+Evjg3xxNYykpLPyA', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1curODlwf2', 0, '5CM+k+Evjg3xxNYykpLPyA', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ${($_ = isset($this->services['request_stack']) ? $this->services['request_stack'] : $this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()) && false ?: '_'}, 'C:\\projet-symfony', '/_profiler/open?file=%f&line=%l#line%l');
    }
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\PostCategoryType' => function () {
            return ${($_ = isset($this->services['AppBundle\Form\PostCategoryType']) ? $this->services['AppBundle\Form\PostCategoryType'] : $this->services['AppBundle\Form\PostCategoryType'] = new \AppBundle\Form\PostCategoryType()) && false ?: '_'};
            ...
            yield 5 => ${($_ = isset($this->services['easyadmin.form.type.extension']) ? $this->services['easyadmin.form.type.extension'] : $this->load(__DIR__.'/getEasyadmin_Form_Type_ExtensionService.php')) && false ?: '_'};
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        })), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\MessageSelector()), 'fr', array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yaml', 1 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => ($this->targetDirs[0].'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf', 1 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.af.yml'), 'ar' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ar.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.ar.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ar.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.ar.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ar.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ar.yml'), 'az' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.az.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.az.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.az.xlf'), 'bg' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.bg.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.bg.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.bg.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.bg.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.bg.yml'), 'ca' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ca.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ca.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.ca.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ca.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ca.yml'), 'cs' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.cs.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.cs.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.cs.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.cs.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.cs.yml'), 'cy' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf'), 'da' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.da.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.da.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.da.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.da.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.da.yml'), 'de' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.de.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.de.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.de.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.de.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.de.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.de.yml'), 'el' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.el.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.el.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.el.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.el.yml'), 'en' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.en.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.en.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.en.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.en.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.en.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.en.yml'), 'es' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.es.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.es.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.es.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.es.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.es.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.es.yml'), 'et' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf', 2 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.et.yml'), 'eu' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf', 2 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.eu.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.eu.xlf', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.eu.yml', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.eu.yml'), 'fa' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fa.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fa.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fa.yml'), 'fi' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf', 2 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.fi.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.fi.xlf', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fi.yml', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fi.yml'), 'fr' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fr.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.fr.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.fr.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.fr.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fr.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fr.yml'), 'gl' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.gl.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.gl.yml'), 'he' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.he.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.he.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.he.yml'), 'hr' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hr.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.hr.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.hr.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.hr.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.hr.yml'), 'hu' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hu.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.hu.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.hu.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.hu.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.hu.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.hu.yml'), 'hy' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf'), 'id' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.id.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.id.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.id.yml'), 'it' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.it.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.it.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.it.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.it.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.it.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.it.yml'), 'ja' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ja.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ja.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ja.yml'), 'lb' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lb.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lb.yml'), 'lt' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lt.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.lt.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.lt.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lt.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.lt.yml'), 'lv' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lv.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lv.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lv.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.lv.yml'), 'mn' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf'), 'nl' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nl.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.nl.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.nl.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.nl.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.nl.yml'), 'nn' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nn.xlf'), 'no' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.no.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.no.xlf'), 'pl' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pl.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.pl.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.pl.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.pl.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pl.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pl.yml'), 'pt' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf', 2 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.pt.yml', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.pt.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.pt.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pt.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pt.yml'), 'pt_BR' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_BR.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pt_BR.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pt_BR.yml'), 'ro' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ro.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ro.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.ro.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ro.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ro.yml'), 'ru' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ru.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.ru.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ru.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.ru.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ru.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ru.yml'), 'sk' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sk.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sk.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sk.yml'), 'sl' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sl.xlf', 3 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.sl.yml', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sl.xlf', 5 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.sl.xlf', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sl.yml', 7 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sl.yml'), 'sq' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf'), 'sr_Cyrl' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Cyrl.xlf'), 'sr_Latn' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Latn.xlf', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sr_Latn.yml', 4 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sr_Latn.yml'), 'sv' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sv.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sv.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.sv.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sv.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sv.yml'), 'th' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.th.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.th.xlf', 2 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.th.yml', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.th.yml'), 'tr' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.tr.xlf', 2 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.tr.yml', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.tr.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.tr.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.tr.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.tr.yml'), 'uk' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.uk.xlf', 2 => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.uk.yml', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.uk.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.uk.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.uk.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.uk.yml'), 'vi' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.vi.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.vi.xlf', 2 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.vi.yml', 3 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.vi.yml'), 'zh_CN' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf', 2 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.zh_CN.xlf', 3 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.zh_CN.xlf', 4 => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\messages.zh_CN.xlf', 5 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.zh_CN.yml', 6 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.zh_CN.yml'), 'zh_TW' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_TW.xlf'), 'pt_PT' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_PT.xlf'), 'ua' => array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ua.xlf'), 'bn' => array(0 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.bn.yml', 1 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.bn.yml'), 'bn_BD' => array(0 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.bn_BD.yml', 1 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.bn_BD.yml'), 'eo' => array(0 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.eo.yml', 1 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.eo.yml'), 'ky' => array(0 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ky.yml', 1 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ky.yml'), 'nb' => array(0 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.nb.yml', 1 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.nb.yml'))));
    ...
    /**
     * Gets the private 'twig.extension.text' shared service.
     *
    ...
    {
        $this->services['twig.loader'] = $instance = new \Twig\Loader\FilesystemLoader(array(), 'C:\\projet-symfony');

        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', '!Framework');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', '!Security');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', '!Twig');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\swiftmailer-bundle/Resources/views', '!Swiftmailer');
        $instance->addPath('C:\\projet-symfony\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\projet-symfony\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $instance->addPath('C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/views', 'VichUploader');
        $instance->addPath('C:\\projet-symfony\\vendor\\vich\\uploader-bundle/Resources/views', '!VichUploader');
        $instance->addPath('C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/views', 'EasyAdmin');
        $instance->addPath('C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/views', '!EasyAdmin');
        $instance->addPath('C:\\projet-symfony\\app/Resources/FOSUserBundle/views', 'FOSUser');
        $instance->addPath('C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/views', '!FOSUser');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/views', 'Debug');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/views', '!Debug');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', '!WebProfiler');
        $instance->addPath('C:\\projet-symfony\\app/Resources/views');
        $instance->addPath('C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle/Resources/config/validation.xml'));
        ...
        $instance->addXmlMapping('C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle\\DependencyInjection\\Compiler/../../Resources/config/storage-validation/orm.xml');
    ...
    {
        return array(
            'kernel.root_dir' => 'C:\\projet-symfony\\app',
            'kernel.project_dir' => 'C:\\projet-symfony',
            ...
            'kernel.bundles_metadata' => array(
                'FrameworkBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'SecurityBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ),
                'TwigBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ),
                'MonologBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ),
                'SwiftmailerBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\symfony\\swiftmailer-bundle',
                    'namespace' => 'Symfony\\Bundle\\SwiftmailerBundle',
                ),
                'DoctrineBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ),
                'SensioFrameworkExtraBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\sensio\\framework-extra-bundle',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ),
                'AppBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\src\\AppBundle',
                    'namespace' => 'AppBundle',
                ),
                'VichUploaderBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\vich\\uploader-bundle',
                    'namespace' => 'Vich\\UploaderBundle',
                ),
                'EasyAdminBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\easycorp\\easyadmin-bundle\\src',
                    'namespace' => 'EasyCorp\\Bundle\\EasyAdminBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\friendsofsymfony\\user-bundle',
                    'namespace' => 'FOS\\UserBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ),
                'WebProfilerBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ),
                'SensioDistributionBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\sensio\\distribution-bundle',
                    'namespace' => 'Sensio\\Bundle\\DistributionBundle',
                ),
                'SensioGeneratorBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\sensio\\generator-bundle',
                    'namespace' => 'Sensio\\Bundle\\GeneratorBundle',
                ),
                'WebServerBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:\\projet-symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebServerBundle',
            ...
            'locale' => 'fr',
            'photo_directory' => 'C:\\projet-symfony/web/uploads',
            ...
            'session.save_path' => 'C:\\projet-symfony/var/sessions/dev',
            ...
            'translator.default_path' => 'C:\\projet-symfony/translations',
            ...
            'router.resource' => 'C:\\projet-symfony/app/config/routing_dev.yml',
            ...
            'twig.default_path' => 'C:\\projet-symfony/templates',
            ...
            'vich_uploader.mappings' => array(
                'post_image' => array(
                    'uri_prefix' => '/uploads',
                    'upload_destination' => 'C:\\projet-symfony/web/uploads',
                    'namer' => array(
                        'service' => 'vich_uploader.namer_property.post_image',
                        'options' => array(
                            'property' => 'renameFile',
                        ),
                    ),
                ...
                'item_image' => array(
                    ...
                    'upload_destination' => 'C:\\projet-symfony/web/uploads/',
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.item_image',
                        'options' => array(
